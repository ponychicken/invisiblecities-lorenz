...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "thread_10_edge.js"},
      { load: "thread_10_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="2048px",plHeight="1536px";
...
preContent={
    dom: [
    {
        ...
        fill: ["rgba(0,0,0,0)",'images/pre10.svg','0px','0px']
    }]};//simpleContent
